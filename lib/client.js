...
[`MQlobberServer`](#mqlobberserver) on its side of the connection. How the
...
via the `handler` function. This should be a topic you've previously passed to
...
separated by `.` (or whatever you configured [`QlobberFSQ`](#qlobberfsqoptions)
with on the server).
